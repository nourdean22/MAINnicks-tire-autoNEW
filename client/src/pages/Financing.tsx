      ...
      <section className="bg-[oklch(0.065_0.004_260)] pt-28 pb-16 lg:pt-36 lg:pb-20">
        <div className="container max-w-4xl text-center">
          ...
          <h1 className="font-bold text-4xl lg:text-6xl text-foreground mt-3 tracking-tight">
            AFFORDABLE <span className="text-primary">REPAIRS</span>
          </h1>
        ...
        <div className="container max-w-4xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {FINANCING_OPTIONS.map((opt) => (
              <div key={opt.title} className="bg-[oklch(0.08_0.004_260/0.8)] border border-[oklch(0.17_0.004_260)] rounded-2xl p-6 lg:p-8 flex flex-col">
                ...
                <div className="bg-primary/10 border border-primary/20 rounded-md p-3 mb-5">
                  <p className="font-bold text-primary text-sm text-center">{opt.highlight}</p>
                </div>
