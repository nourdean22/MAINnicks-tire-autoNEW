            ...
            <FadeIn>
              <div>
                ...
                <div className="mt-6 space-y-3">
                  <div className="flex items-center gap-3 stagger-in text-foreground/80">
            ...
            <FadeIn delay={0.15}>
              <div className="bg-card/50 border border-border/50 rounded-lg overflow-hidden h-96">
                <iframe
                  ...
                  src={(import.meta.env.VITE_GOOGLE_MAPS_EMBED_KEY || import.meta.env.VITE_GOOGLE_MAPS_API_KEY) ? `https://www.google.com/maps/embed/v1/directions?key=${import.meta.env.VITE_GOOGLE_MAPS_EMBED_KEY || import.meta.env.VITE_GOOGLE_MAPS_API_KEY}&origin=${neighborhood.lat},${neighborhood.lng}&destination=${BUSINESS.geo.lat},${BUSINESS.geo.lng}` : `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2988.5!2d-81.5268!3d41.5932!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDHCsDM1JzM1LjUiTiA4McKwMzEnMzYuNSJX!5e0!3m2!1sen!2sus!4v1`}
                />
              </div>
            </FadeIn>
          </div>
