      ...
      />
          ...
          <div className="relative container">
            ...
            <FadeIn delay={0.2}>
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <a href="tel:2168620005" onClick={() => trackPhoneClick(`problem-${page.slug}-hero`)} className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-4 font-semibold font-bold text-lg tracking-wider uppercase hover:bg-primary/90 transition-colors">
          ...
          <div className="container text-center">
            <FadeIn>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                <a href="tel:2168620005" onClick={() => trackPhoneClick(`problem-${page.slug}-bottom-cta`)} className="inline-flex items-center justify-center gap-2 bg-nick-dark text-foreground px-8 py-4 font-semibold font-bold text-lg tracking-wider uppercase hover:bg-nick-dark/90 transition-colors">
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-nick-dark/95 backdrop-blur-md border-t border-border p-3">
          <div className="flex gap-2">
            <a href="tel:2168620005" onClick={() => trackPhoneClick(`problem-${page.slug}-sticky`)} aria-label="Call Nick's Tire and Auto" className="flex-1 flex items-center justify-center gap-2 bg-primary text-primary-foreground py-3 font-semibold font-bold text-sm tracking-wider uppercase">
