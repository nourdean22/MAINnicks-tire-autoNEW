    ...
    <nav aria-label="Main navigation" className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-nick-dark/95 backdrop-blur-md shadow-lg" : "bg-nick-dark/90 backdrop-blur-sm"}`}>
      <div className="container flex items-center justify-between h-16 lg:h-20">
        ...
        <div className="hidden lg:flex items-center gap-8">
          ...
          <a href="tel:2168620005" onClick={() => trackPhoneClick("problem-nav")} aria-label="Call Nick's Tire and Auto at 216-862-0005" className="flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 font-heading font-bold text-sm tracking-wider uppercase hover:bg-primary/90 transition-colors">
      ...
      {mobileOpen && (
        <div className="lg:hidden bg-nick-dark/98 backdrop-blur-md border-t border-border">
          <div className="container py-6 flex flex-col gap-4">
            ...
            <a href="tel:2168620005" onClick={() => trackPhoneClick("problem-mobile-nav")} className="flex items-center justify-center gap-2 bg-primary text-primary-foreground px-5 py-3 font-heading font-bold text-sm tracking-wider uppercase mt-2">
              <Phone className="w-4 h-4" />(216) 862-0005
            </a>
          </div>
        </div>
      ...
      <main id="main-content" className="bg-nick-dark">
          ...
          <div className="relative container">
            ...
            <FadeIn delay={0.2}>
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <a href="tel:2168620005" onClick={() => trackPhoneClick(`problem-${page.slug}-hero`)} className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-4 font-heading font-bold text-lg tracking-wider uppercase hover:bg-primary/90 transition-colors">
        ...
        <section className="py-16 lg:py-20 border-t border-border/30">
          <div className="container max-w-4xl">
            <FadeIn>
              <span className="font-mono text-primary text-sm tracking-widest uppercase">Understanding the Problem</span>
          ...
          <div className="container max-w-4xl">
            <FadeIn>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="font-heading font-bold text-xl lg:text-2xl text-red-400 tracking-tight mb-3">
                    WHEN TO STOP DRIVING
                  </h2>
        ...
        <section className="py-16 lg:py-20 section-darker">
          <div className="container">
            <FadeIn>
              <span className="font-mono text-primary text-sm tracking-widest uppercase">Root Causes</span>
                ...
                <FadeIn key={i} delay={i * 0.08}>
                  <div className="border border-border/40 p-6 bg-card/30">
                    <div className="flex items-start justify-between mb-3 flex-wrap gap-2">
                      <h3 className="font-heading font-bold text-lg text-foreground">{cause.cause}</h3>
        ...
        <section className="py-16 lg:py-20">
          <div className="container max-w-4xl">
            <FadeIn>
              <span className="font-mono text-primary text-sm tracking-widest uppercase">Our Approach</span>
              <h2 className="font-heading font-bold text-3xl lg:text-4xl text-foreground mt-3 tracking-tight mb-6">
          ...
          <div className="container text-center">
            <FadeIn>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                <a href="tel:2168620005" onClick={() => trackPhoneClick(`problem-${page.slug}-bottom-cta`)} className="inline-flex items-center justify-center gap-2 bg-nick-dark text-foreground px-8 py-4 font-heading font-bold text-lg tracking-wider uppercase hover:bg-nick-dark/90 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div className="space-y-2 text-foreground/60 text-sm">
                  ...
                  <div className="flex items-center gap-2"><Phone className="w-4 h-4 text-primary" /><a href="tel:2168620005" onClick={() => trackPhoneClick(`problem-${page.slug}-footer`)} className="hover:text-primary transition-colors">(216) 862-0005</a></div>
                  <div className="flex items-center gap-2"><Clock className="w-4 h-4 text-primary" />Mon–Sat 9AM–6PM</div>
                </div>
              </div>
              <div>
                <h4 className="font-heading font-bold text-foreground tracking-wider text-sm uppercase mb-4">Common Problems</h4>
                <div className="space-y-2 text-foreground/60 text-sm">
                  <Link href="/car-shaking-while-driving" className="block hover:text-primary transition-colors">Car Shaking While Driving</Link>
                  <Link href="/brakes-grinding" className="block hover:text-primary transition-colors">Brakes Grinding</Link>
                  <Link href="/check-engine-light-flashing" className="block hover:text-primary transition-colors">Check Engine Light Flashing</Link>
                  <Link href="/car-overheating" className="block hover:text-primary transition-colors">Car Overheating</Link>
                </div>
              </div>
            </div>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-nick-dark/95 backdrop-blur-md border-t border-border p-3">
          <div className="flex gap-2">
            <a href="tel:2168620005" onClick={() => trackPhoneClick(`problem-${page.slug}-sticky`)} aria-label="Call Nick's Tire and Auto" className="flex-1 flex items-center justify-center gap-2 bg-primary text-primary-foreground py-3 font-heading font-bold text-sm tracking-wider uppercase">
