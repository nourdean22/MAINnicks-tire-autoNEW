...
const ALL_LINKS: LinkItem[] = [
  ...
  { href: "/brakes", label: "Brake Repair Cleveland", desc: "Brakes starting at $129/axle — pads, rotors, calipers" },
  ...
  { href: "/oil-change", label: "Oil Change Cleveland", desc: "Starting at $29.99 — conventional and synthetic" },
  ...
  { href: "/alignment", label: "Wheel Alignment Cleveland", desc: "Starting at $89 — fix pulling and uneven tire wear" },
