...
const LEGAL_PAGES: RouteEntry[] = [
  {
    ...
    description: "Privacy policy for autonicks.com. How we collect, use, and protect your information at Nick's Tire & Auto, Cleveland, OH.",
    group: "legal",
    sitemap: true,
    prerender: true,
  },
  {
    ...
    description: "Terms of service for autonicks.com. Usage terms for Nick's Tire & Auto website and services, Cleveland, OH.",
    group: "legal",
    sitemap: true,
    prerender: true,
  },
