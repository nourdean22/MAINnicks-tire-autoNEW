...
const CITY_PAGES: RouteEntry[] = [
  ...
  },
  {
    ...
    priority: 0.8,
    changefreq: "monthly",
    title: "Auto Repair Parma Heights OH — Nick's Tire & Auto",
    description: "Auto repair serving Parma Heights drivers. Brakes from $89, tires from $60. 4.9★ (1,700+ reviews). 36-month warranty. Call (216) 862-0005.",
    group: "city",
    sitemap: true,
    prerender: true,
  },
  {
    path: "/wickliffe-auto-repair",
    priority: 0.8,
    changefreq: "monthly",
    title: "Auto Repair Wickliffe OH — Nick's Tire & Auto",
    description: "Auto repair near Wickliffe, OH. Tires, brakes, diagnostics, oil changes. 4.9★ rated, 1,700+ reviews. Walk-ins welcome. Call (216) 862-0005.",
    group: "city",
    sitemap: true,
    prerender: true,
  },
