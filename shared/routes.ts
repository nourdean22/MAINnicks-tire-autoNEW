...
const NEIGHBORHOOD_PAGES: RouteEntry[] = [
  ...
  { path: "/mentor-on-the-lake", priority: 0.6, changefreq: "monthly", title: "Auto Repair Mentor-on-the-Lake — Nick's Tire & Auto", description: "Trusted auto repair serving Mentor-on-the-Lake. Quality service, honest pricing. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/willoughby-hills", priority: 0.6, changefreq: "monthly", title: "Auto Repair Willoughby Hills OH — Nick's Tire & Auto", description: "Expert auto repair near Willoughby Hills. Brakes, tires, diagnostics. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/euclid-ohio", priority: 0.8, changefreq: "monthly", title: "Auto Repair Euclid Ohio — Nick's Tire & Auto", description: "Your neighborhood auto repair shop in Euclid. Located on Euclid Ave. Walk-ins welcome 7 days.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/east-cleveland", priority: 0.7, changefreq: "monthly", title: "Auto Repair East Cleveland OH — Nick's Tire & Auto", description: "Affordable auto repair serving East Cleveland. Expert mechanics, fair prices. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/cleveland-heights-mechanic", priority: 0.7, changefreq: "monthly", title: "Mechanic Cleveland Heights — Nick's Tire & Auto", description: "Quality auto repair near Cleveland Heights. Oil changes to engine repair. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/garfield-heights", priority: 0.6, changefreq: "monthly", title: "Auto Repair Garfield Heights OH — Nick's Tire & Auto", description: "Reliable auto repair serving Garfield Heights. Tires, brakes, diagnostics. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/maple-heights", priority: 0.6, changefreq: "monthly", title: "Auto Repair Maple Heights OH — Nick's Tire & Auto", description: "Expert mechanics serving Maple Heights. Full-service repair, transparent pricing.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/parma-heights", priority: 0.6, changefreq: "monthly", title: "Auto Repair Parma Heights — Nick's Tire & Auto", description: "Trusted auto repair for Parma Heights. All makes and models. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/shaker-heights", priority: 0.7, changefreq: "monthly", title: "Auto Repair Near Shaker Heights — Nick's Tire & Auto", description: "Professional auto repair serving Shaker Heights. Expert diagnostics, quality parts.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/warrensville-heights", priority: 0.6, changefreq: "monthly", title: "Auto Repair Warrensville Heights — Nick's Tire & Auto", description: "Reliable auto repair for Warrensville Heights. Affordable service, experienced mechanics.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/lakewood-auto-repair", priority: 0.7, changefreq: "monthly", title: "Auto Repair Lakewood OH — Nick's Tire & Auto", description: "Quality auto repair for Lakewood drivers. Expert mechanics, fair pricing.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/willoughby-ohio", priority: 0.7, changefreq: "monthly", title: "Auto Repair Willoughby OH — Nick's Tire & Auto", description: "Expert auto repair serving Willoughby and Lake County. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/bedford-ohio", priority: 0.6, changefreq: "monthly", title: "Auto Repair Bedford OH — Nick's Tire & Auto", description: "Trusted mechanics serving Bedford. Honest diagnostics, quality repairs.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/north-collinwood", priority: 0.7, changefreq: "monthly", title: "Auto Repair North Collinwood — Nick's Tire & Auto", description: "Your local shop in North Collinwood. Quick turnaround, honest service.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/downtown-cleveland", priority: 0.7, changefreq: "monthly", title: "Auto Repair Downtown Cleveland — Nick's Tire & Auto", description: "Convenient auto repair for downtown Cleveland commuters. Drop off and pick up.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/tremont-cleveland", priority: 0.6, changefreq: "monthly", title: "Auto Repair Tremont Cleveland — Nick's Tire & Auto", description: "Quality auto repair for Tremont residents. Independent, honest mechanics.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/ohio-city", priority: 0.6, changefreq: "monthly", title: "Auto Repair Ohio City Cleveland — Nick's Tire & Auto", description: "Expert auto repair serving Ohio City. All makes, honest pricing.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/rocky-river", priority: 0.6, changefreq: "monthly", title: "Auto Repair Rocky River OH — Nick's Tire & Auto", description: "Professional auto repair serving Rocky River. Expert diagnostics, fair prices.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/solon-ohio", priority: 0.6, changefreq: "monthly", title: "Auto Repair Solon OH — Nick's Tire & Auto", description: "Trusted auto repair for Solon residents. Quality parts, honest work.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/broadview-heights", priority: 0.6, changefreq: "monthly", title: "Auto Repair Broadview Heights — Nick's Tire & Auto", description: "Quality auto repair serving Broadview Heights. Tires, brakes, engine repair.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/chagrin-falls", priority: 0.6, changefreq: "monthly", title: "Auto Repair Chagrin Falls OH — Nick's Tire & Auto", description: "Expert auto repair for Chagrin Falls. Honest diagnostics, premium service.", group: "neighborhood", sitemap: true, prerender: true },
];
