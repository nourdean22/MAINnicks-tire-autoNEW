...
const NEIGHBORHOOD_PAGES: RouteEntry[] = [
  ...
  { path: "/severance-town-center", priority: 0.7, changefreq: "monthly", title: "Auto Repair Severance Town Center — Nick's Tire", description: "Auto repair near Severance Town Center, Cleveland Heights. Nick's Tire & Auto — 4.9 stars, 1,685+ reviews. Tires, brakes, diagnostics, oil changes.", group: "neighborhood", sitemap: true, prerender: true },
  ...
  { path: "/south-euclid-mechanic", priority: 0.7, changefreq: "monthly", title: "Mechanic South Euclid OH — Nick's Tire & Auto", description: "Trusted mechanic near South Euclid, OH. Nick's Tire & Auto — 4.9 stars, 1,685+ reviews. Tires, brakes, oil changes, diagnostics. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/lyndhurst-mechanic", priority: 0.7, changefreq: "monthly", title: "Mechanic Lyndhurst OH — Nick's Tire & Auto", description: "Trusted mechanic near Lyndhurst, OH. Nick's Tire & Auto — 4.9 stars, 1,685+ reviews. Tires, brakes, oil changes, diagnostics. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/mayfield-heights", priority: 0.7, changefreq: "monthly", title: "Auto Repair Near Mayfield Heights OH — Nick's Tire", description: "Auto repair near Mayfield Heights, OH. Nick's Tire & Auto — 4.9 stars, 1,685+ reviews. Tires, brakes, oil changes, diagnostics. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/highland-heights", priority: 0.7, changefreq: "monthly", title: "Auto Repair Near Highland Heights OH — Nick's Tire", description: "Auto repair near Highland Heights, OH. Nick's Tire & Auto — 4.9 stars, 1,685+ reviews. Tires, brakes, oil changes, diagnostics. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  ...
  { path: "/east-cleveland", priority: 0.7, changefreq: "monthly", title: "Auto Repair East Cleveland OH — Nick's Tire & Auto", description: "Affordable auto repair serving East Cleveland, OH. Tires, brakes, engine diagnostics, oil changes, and emissions. Expert mechanics, fair prices.", group: "neighborhood", sitemap: true, prerender: true },
  ...
  { path: "/garfield-heights", priority: 0.6, changefreq: "monthly", title: "Auto Repair Garfield Heights OH — Nick's Tire & Auto", description: "Reliable auto repair serving Garfield Heights, OH. Tires, brakes, engine diagnostics, oil changes, and emissions repair. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  ...
  { path: "/lakewood-auto-repair", priority: 0.7, changefreq: "monthly", title: "Auto Repair Lakewood OH — Nick's Tire & Auto", description: "Quality auto repair for Lakewood, OH drivers. Tires, brakes, engine diagnostics, oil changes, and emissions repair. Expert mechanics, fair pricing.", group: "neighborhood", sitemap: true, prerender: true },
  ...
  { path: "/independence-ohio", priority: 0.6, changefreq: "monthly", title: "Auto Repair Independence OH — Nick's Tire & Auto", description: "Reliable auto repair for Independence, OH. Same-day brake, tire, diagnostic, and oil change service. 4.9 stars, 1,685+ reviews. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
...
const VEHICLE_PAGES: RouteEntry[] = [
  ...
  { path: "/bmw-repair-cleveland", priority: 0.7, changefreq: "monthly", title: "BMW Repair Cleveland OH — Nick's Tire & Auto", description: "BMW repair specialists in Cleveland, OH. 3 Series, 5 Series, X3, X5 service and diagnostics. European car experts. 4.9 stars, 1,685+ reviews.", group: "vehicle", sitemap: true, prerender: true },
  { path: "/dodge-ram-repair-cleveland", priority: 0.7, changefreq: "monthly", title: "Dodge & Ram Repair Cleveland — Nick's Tire & Auto", description: "Dodge and Ram repair specialists in Cleveland, OH. Charger, Challenger, Ram 1500 service and diagnostics. 4.9 stars, 1,685+ reviews.", group: "vehicle", sitemap: true, prerender: true },
];
