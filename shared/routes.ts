...
const NEIGHBORHOOD_PAGES: RouteEntry[] = [
  ...
  { path: "/bainbridge-ohio", priority: 0.5, changefreq: "monthly", title: "Auto Repair Bainbridge OH — Nick's Tire & Auto", description: "Trusted auto repair for Bainbridge Township. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/pepper-pike", priority: 0.6, changefreq: "monthly", title: "Auto Repair Pepper Pike — Nick's Tire & Auto", description: "Professional auto repair near Pepper Pike. Expert diagnostics.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/gates-mills", priority: 0.5, changefreq: "monthly", title: "Auto Repair Gates Mills — Nick's Tire & Auto", description: "Expert auto repair for Gates Mills. Quality parts, honest work.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/independence-ohio", priority: 0.6, changefreq: "monthly", title: "Auto Repair Independence OH — Nick's Tire & Auto", description: "Reliable auto repair for Independence. Same-day service.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/strongsville-ohio", priority: 0.6, changefreq: "monthly", title: "Auto Repair Strongsville OH — Nick's Tire & Auto", description: "Quality auto repair serving Strongsville. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/north-royalton", priority: 0.6, changefreq: "monthly", title: "Auto Repair North Royalton — Nick's Tire & Auto", description: "Trusted auto repair for North Royalton. Fair pricing.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/bay-village", priority: 0.5, changefreq: "monthly", title: "Auto Repair Bay Village OH — Nick's Tire & Auto", description: "Expert auto repair for Bay Village. Professional service.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/westlake-ohio", priority: 0.6, changefreq: "monthly", title: "Auto Repair Westlake OH — Nick's Tire & Auto", description: "Professional auto repair serving Westlake. Quality parts.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/north-olmsted", priority: 0.6, changefreq: "monthly", title: "Auto Repair North Olmsted — Nick's Tire & Auto", description: "Reliable auto repair for North Olmsted. Walk-ins welcome.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/middleburg-heights", priority: 0.5, changefreq: "monthly", title: "Auto Repair Middleburg Heights — Nick's Tire & Auto", description: "Trusted auto repair for Middleburg Heights.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/brook-park", priority: 0.5, changefreq: "monthly", title: "Auto Repair Brook Park — Nick's Tire & Auto", description: "Expert auto repair near Cleveland Hopkins Airport area.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/avon-ohio", priority: 0.5, changefreq: "monthly", title: "Auto Repair Avon OH — Nick's Tire & Auto", description: "Quality auto repair serving Avon. Transparent pricing.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/avon-lake", priority: 0.5, changefreq: "monthly", title: "Auto Repair Avon Lake OH — Nick's Tire & Auto", description: "Trusted auto repair for Avon Lake. Professional service.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/twinsburg-ohio", priority: 0.5, changefreq: "monthly", title: "Auto Repair Twinsburg OH — Nick's Tire & Auto", description: "Expert auto repair for Twinsburg. Brakes, tires, diagnostics.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/aurora-ohio", priority: 0.5, changefreq: "monthly", title: "Auto Repair Aurora OH — Nick's Tire & Auto", description: "Trusted auto repair for Aurora. Quality parts, expert mechanics.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/streetsboro", priority: 0.5, changefreq: "monthly", title: "Auto Repair Streetsboro OH — Nick's Tire & Auto", description: "Reliable auto repair serving Streetsboro. Honest pricing.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/chardon-ohio", priority: 0.5, changefreq: "monthly", title: "Auto Repair Chardon OH — Nick's Tire & Auto", description: "Expert auto repair for Chardon. Snow belt tire specialists.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/painesville-ohio", priority: 0.5, changefreq: "monthly", title: "Auto Repair Painesville OH — Nick's Tire & Auto", description: "Trusted auto repair serving Painesville and Lake County.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/mentor-ohio", priority: 0.6, changefreq: "monthly", title: "Auto Repair Mentor OH — Nick's Tire & Auto", description: "Quality auto repair for Mentor. Expert tires, brakes, diagnostics.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/university-heights", priority: 0.6, changefreq: "monthly", title: "Auto Repair University Heights — Nick's Tire & Auto", description: "Professional auto repair near University Heights.", group: "neighborhood", sitemap: true, prerender: true },
  { path: "/parma-ohio", priority: 0.7, changefreq: "monthly", title: "Auto Repair Parma OH — Nick's Tire & Auto", description: "Trusted auto repair for Parma. Honest work, fair prices.", group: "neighborhood", sitemap: true, prerender: true },
];
