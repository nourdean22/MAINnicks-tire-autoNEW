...
const SEO_SERVICE_PAGES: RouteEntry[] = [
  ...
  { path: "/check-engine-light-cleveland", priority: 0.8, changefreq: "monthly", title: "Check Engine Light Cleveland — Nick's Tire & Auto", description: "Check engine light on in Cleveland? Expert OBD-II diagnostics. We pinpoint the exact cause. 4.9 stars, 1,685+ reviews. Walk-ins welcome.", group: "seo-service", sitemap: true, prerender: true },
